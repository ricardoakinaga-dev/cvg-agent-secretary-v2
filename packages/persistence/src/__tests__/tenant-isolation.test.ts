  ...
  itWithPostgres(
    ...
    async () => {
      ...
      try {
        ...
        await admin.query(
          `GRANT SELECT, INSERT, UPDATE, DELETE ON ${schemaName}.conversations, ${schemaName}.messages, ${schemaName}.sessions, ${schemaName}.agent_runs, ${schemaName}.tool_calls, ${schemaName}.approval_requests, ${schemaName}.tasks, ${schemaName}.audit_events, ${schemaName}.idempotency, ${schemaName}.outbox_events, ${schemaName}.outbox_effects, ${schemaName}.outbox_attempts, ${schemaName}.runtime_audit_events, ${schemaName}.platform_agents, ${schemaName}.platform_agent_versions, ${schemaName}.platform_test_runs, ${schemaName}.platform_execution_traces, ${schemaName}.platform_capability_approvals, ${schemaName}.platform_test_suites, ${schemaName}.platform_test_suite_runs, ${schemaName}.platform_plugin_catalog, ${schemaName}.platform_knowledge_sources, ${schemaName}.platform_release_candidates, ${schemaName}.audit_evidence_checkpoints TO ${roleName}`
        )
        await admin.query(
        ...
        await admin.query(
          `INSERT INTO outbox_events (id, type, payload, status, tenant_id)
           VALUES
             ...
             ($4, 'message.outbound', $5::jsonb, 'pending', $6),
